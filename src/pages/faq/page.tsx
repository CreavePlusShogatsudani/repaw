  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 'Webフォームから申し込み → お手持ちの箱や袋に梱包して着払いで発送（送り先は申し込み完了画面とマイページに表示）→ 到着後に査定（2〜3営業日）→ マイページで査定結果のご確認 → 入金・寄付・返送の選択、という流れです。配送キットの送付はありません。'
      },
      {
      ...
      },
      {
        ...
        answer: 'ブランド、状態、需要、季節などをもとに、届いた商品を1点ずつ査定します。査定結果はマイページでご確認いただき、寄付・振込・返送をお選びいただけます。'
      },
      {
        question: '複数点まとめて買取できますか？',
        answer: 'はい、可能です。まとめて買取いただくことで、査定もスムーズに進みます。何点でもまとめてお送りいただけます。着払いのため送料のご負担はありません。'
      }
    ]
  },
  {
